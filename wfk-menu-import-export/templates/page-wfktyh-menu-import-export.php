...
<div class="wrap">
    <div class="wfp_menu_import_export_container">
        <h1><?php esc_html_e("Menu Import Export","wfktyh-menu-import-export"); ?></h1>

        <div class="wfk_vertical_tabs_container">
            <div class="tabs-btn mie-lg-4">
                <ul class="nav nav-pills">
                    <li class="tab-button active" >
                        <a href="#"  data-tab="wfk-export-content"><?php esc_html_e("Export","wfktyh-menu-import-export") ?></a>
                    </li>
                    <li class="tab-button">
                        <a href="#"  data-tab="wfk-import-content"><?php esc_html_e("Import","wfktyh-menu-import-export") ?></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="mfk-tabconten_wrap mie-lg-8">
                <div id="wfk-export-content" class="mfk-mie_tabcontent default">
                    <div class="wfp_importexport card">
                        <label for="select-menu-import-export" class="selected-menu"
                            style="display: block;"><?php esc_html_e( 'Select a menu to Export:' );?></label>
                        ...
                        <form action="" method="post">
                            ...
                            <select name="menu" id="select-menu-import-export" class="wfp-mie-select">
                                <option value=""><?php esc_html_e( "Select Menu", "wfktyh-menu-import-export" )?></option>
                            ...
                            <div class="wfk_menuie_lists">
                                ...
                                <a href="#" class="wfk_menu_export_btn" id="wfk_menu_export_btn"><?php esc_html_e("Export","wfktyh-menu-import-export") ?></a>
                            </div>
                        </form>
                        <?php }else{
                ...
                <div id="wfk-import-content" class="mfk-mie_tabcontent">
                    <div class="container">
                        <div class="card">
                            <h3><?php esc_html_e("Upload Menu Json File","wfktyh-menu-import-export") ?></h3>
                            ...
                            <form  id="wfk_mie_import_form" method="post" enctype="multipart/form-data">
                                     ...
                                     <input type="file" hidden accept=".json" name="mie_import_file" id="menuJsonFile" style="display:none;">
                                        <header id="fileHeaderText">
                                            <h4><?php esc_html_e("Select File here","wfktyh-menu-import-export") ?></h4>
                                        </header>
                                        <div class="menu_name_input">
                                             <p><?php esc_html_e("Files Supported Only Json","wfktyh-menu-import-export") ?></p>    
                                        </div>
                                        <button class="btn chooseMenuFile"><?php esc_html_e("Choose File","wfktyh-menu-import-export") ?></button>
                                    </div>
                                <button type="submit" class="wfk_menu_import_btn" id="wfk_menu_import_btn"><?php esc_html_e("Import","wfktyh-menu-import-export") ?></button>
                            </form>
                        </div>
                    </div>
                </div>

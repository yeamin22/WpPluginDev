 ...
 * @since 1.0.0
 */
class Wdfe_TextEmoji extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		...
		wp_register_script( 'emojionearea-control', WDFE_PLUGIN_URI . "/assets/js/controls/wdfe_textemoji.js", [ 'emojionearea' ], '1.0.0' );
